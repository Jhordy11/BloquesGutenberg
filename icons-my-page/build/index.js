...
function Edit(props) {
  const icons = [{
    icono: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
      stroke: "currentColor",
      fill: "currentColor",
      "stroke-width": "0",
  ...
  return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
    beforeIcon: "arrow-left-alt2",
    afterIcon: "arrow-right-alt2",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Icono", "iconsmypage"),
    value: numIcon,
    onChange: numIcon => setAttributes({
      numIcon
    }),
    min: 1,
    max: icons.length
    ...
    className: "skills__icons__detalles__icon"
  }, icons[numIcon - 1].icono, icons[numIcon - 1].icono), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "skills__icons__detalles__nombre"
  }, icons[numIcon - 1].nombre), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "skills__icons__detalles__nivel"
  }, icons[numIcon - 1].nivel))];
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/icons-my-page","version":"0.1.0","title":"Icons My Page","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","supports":{"html":false},"attributes":{"numIcon":{"type":"number","default":1}},"textdomain":"icons-my-page","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkicons_my_page"] = self["webpackChunkicons_my_page"] || [];
