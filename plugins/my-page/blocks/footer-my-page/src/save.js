		...
		<div { ...useBlockProps.save() }>
			...
			<footer className="pieDePagina">
				...
				>
					...
					>
						<svg className="pieDePagina__iconos__icon" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em"
					...
					<a
						...
						rel="noopener noreferrer"
					>
						<svg className="pieDePagina__iconos__icon" stroke="currentColor" fill="currentColor"
