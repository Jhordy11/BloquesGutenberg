...
export default function Edit(props) {
	const {
		attributes: {images, sMiniIcon, titulo, linkGit, linkWeb},
		setAttributes,
	} = props;
	...
	const icons = [<svg className="card__saberMas__links__link_icon" stroke="currentColor" fill="currentColor"
		...
		<svg className="card__saberMas__links__link_icon" stroke="currentColor" fill="currentColor" stroke-width="0"
	...
	const miniIcons = [
		<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em"
			 xmlns="http://www.w3.org/2000/svg">
			<path
				d="M145.2 96l66 746.6L512 928l299.6-85.4L878.9 96H145.2zm595 177.1l-4.8 47.2-1.7 19.5H382.3l8.2 94.2h335.1l-3.3 24.3-21.2 242.2-1.7 16.2-187 51.6v.3h-1.2l-.3.1v-.1h-.1l-188.6-52L310.8 572h91.1l6.5 73.2 102.4 27.7h.4l102-27.6 11.4-118.6H510.9v-.1H306l-22.8-253.5-1.7-24.3h460.3l-1.6 24.3z"></path>
		</svg>,
		<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em"
			 xmlns="http://www.w3.org/2000/svg">
			<path
				d="M256.282 339.488zM64 32l34.946 403.219L255.767 480l157.259-44.85L448 32H64zm290.676 334.898l-98.607 28.125-98.458-28.248L150.864 289h48.253l3.433 39.562 53.586 15.163.132.273h.034l53.467-14.852L315.381 265H203l-4-50h120.646l4.396-51H140l-4-49h240.58l-21.904 251.898z"></path>
		</svg>,
		<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em"
			 xmlns="http://www.w3.org/2000/svg">
			<path
	...
	return [<InspectorControls>
		<PanelBody title={__("Config proyecto", "proyectomypage")}
				   initialOpen={true}>
			<TextControl
				label={__("Escribe el titulo", "proyectomypage")}
				value={titulo}
				onChange={(titulo)=>setAttributes({titulo})}
			/>
			<TextControl
				label={__("Tecnologias usadas 0,1,2..9", "proyectomypage")}
				value={sMiniIcon}
				onChange={(sMiniIcon)=>setAttributes({sMiniIcon})}
			/>
			<TextControl
				label={__("Escribe el url del repositorio git", "proyectomypage")}
				value={linkGit}
				onChange={(linkGit)=>setAttributes({linkGit})}
			/>
			<TextControl
				label={__("Escribe el url de la web", "proyectomypage")}
				value={linkWeb}
				onChange={(linkWeb)=>setAttributes({linkWeb})}
			/>
		</PanelBody>
					...
					<MediaUpload
						...
						render={({open}) => (
							<IconButton
								...
								label={__("Cambiar imagenes", "proyectomypage")}
								icon="edit"
								onClick={open}
							/>
						)}
		...
		<div {...useBlockProps()}>
			...
			<>
				...
				<section className="card__saberMas">
					...
					<section className="card__saberMas__tecnologias">
						{sMiniIcon.split(",").map((number, index) =>
							<li className="card__saberMas__tecnologias__icon" key={index}>{miniIcons[number]}</li>)}
					</section>
				</section>
				<h3 className="card__name">{titulo}</h3>
