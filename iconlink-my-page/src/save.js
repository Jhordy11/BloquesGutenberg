...
export default function save() {
	return (
		<div { ...useBlockProps.save() }>
			...
			>
				<svg className="sobreMi__presentacion__iconos__icon" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em"
			...
			<a
				...
				rel="noopener noreferrer"
			>
				<svg className="sobreMi__presentacion__iconos__icon" stroke="currentColor" fill="currentColor"
